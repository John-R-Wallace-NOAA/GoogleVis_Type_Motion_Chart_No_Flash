...
During the interactive demo, after (or before) hitting play, hover around with the mouse cursor in the plotting area then left-click on a country. To go back, left-click on the white background of the plotting area and then hover around with the cursor on top of where other currently invisible data occurs. 
